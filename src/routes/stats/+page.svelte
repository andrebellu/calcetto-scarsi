    ...
    {:else}
        ...
        {#if selectedTab === "presenze"}
            <Card.Root class="mb-6 w-full">
                <Card.Header class={undefined}>
                    <Card.Title class={undefined}
                        >Classifica Media Gol</Card.Title
                    >
                    <Card.Description class={undefined}
        ...
        {#if selectedTab === "graphs"}
            ...
            >
                ...
                >
                    Nota: i grafici sono ottimizzati per schermi desktop; su
                    mobile potrebbe essere necessario scorrere orizzontalmente o
                    ruotare il dispositivo per una migliore leggibilità.
                </p>
                <div class="w-full overflow-x-auto no-scrollbar">
                    <div
                        class="min-w-[560px] md:min-w-0 aspect-16/10 md:aspect-video mx-auto"
                    >
                        <Chart.Container
                            class={undefined}
