    ...
    (options ?? [])
      .map((opt) => {
        ...
        const labelFull = [dayName, dayShort, timeLabel]
          .filter(Boolean)
          .join(" • ");
        const labelShort = [dayShort, timeLabel].filter(Boolean).join(" ");
        return {
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div class="space-y-1">
                    <label class="text-xs text-muted-foreground">
                      Note
                      <input
                        class="w-full border rounded-md px-2 py-1.5 text-sm mt-1"
        ...
        >
                      ...
                      <AlertDialog.Root>
                        ...
                        >
                          <AlertDialog.Header class="">
                            ...
                            >
                            <AlertDialog.Description class="">
                              Questa scelta è necessaria per votare e non potrà
                              essere modificata facilmente.
                            </AlertDialog.Description>
                          </AlertDialog.Header>
                          <AlertDialog.Footer class="">
                            <AlertDialog.Cancel
                ...
                >
                  <div class="flex items-start justify-between">
                    <div class="flex flex-col">
                      <div class="font-bold text-lg capitalize">
                        {dayName}
                        <span
                          class="font-normal text-muted-foreground text-base"
                          >| {dayShort}</span
                        >
                      </div>
                      <div
                  ...
                  >
                    <div class="text-xs font-medium text-muted-foreground">
                      {#if (counts[opt.option_id] ?? 0) === 0}
                        Nessun voto
                      {:else}
                        <span class="text-primary font-bold"
                          >{counts[opt.option_id]}</span
                        > voti
                      {/if}
                    </div>
          ...
          <Card.Root class="flex flex-col">
            <Card.Header class="items-center text-center">
              <Card.Title class={undefined}>Preferenze per data</Card.Title>
